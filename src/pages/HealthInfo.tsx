    ...
    try {
      ...
      if (data) {
        form.reset({
          ...
          weight: data.weight || '',
          age: data.age || '',
          currentHealthCondition: data.current_health_condition || '',
          previousHealthConditions: data.previous_health_conditions || '',
    ...
    try {
      const { error } = await supabase
        ...
        .upsert({
          ...
          age: values.age,
          current_health_condition: values.currentHealthCondition,
          previous_health_conditions: values.previousHealthConditions,
